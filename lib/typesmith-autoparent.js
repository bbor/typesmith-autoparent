...
function plugin(opts) {
  ...
  return function(typesmith, done){
    ...
    var config = Object.assign({}, plugin_defaults, typesmith.config['typesmith-autoparent'], opts);
    ...
    Object.keys(typesmith.db).forEach( function(uid) {
      ...
      var final_config = Object.assign({}, config, type_config, record);
      ...
      for (var i_parent = 0; i_parent < possible_parents.length; i_parent++)
      {
        ...
        parent_final_config = Object.assign({}, config, parent_type_config, possible_parent);
